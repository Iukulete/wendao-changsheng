...
- **大道与器物层级**：普通兵刃/法宝、本命至宝、后天通天灵宝、先天通天灵宝、鸿蒙至宝、万道本命至宝各有定位，道祖与所掌大道共生
- **寿元压力**：仙帝以下仍受寿数追赶，寿元临近会进入 AI 上下文并触发延寿、闭死关或证道取舍；道祖才不再被寿元逼迫
- **本世器物**：今生得到的兵刃和普通法宝会进入本世记录，并拥有凡器、法器、灵宝、仙器、道器等器境
- **器物历练事件**：本世兵刃或法宝会在历练中应劫、破局、温养或封存器痕；未达通天层次不能稳定跨世
- **灵宝觉醒**：本命至宝可随主人道途成长，后天触及通天灵宝；后天通天灵宝可长存但久无人温养会衰退，先天通天灵宝自带先天一气
...
- **九大鸿蒙至宝**：九件创世级恒在之物，各有固定权柄、显化和禁忌；知者极少，正常修士眼中先天通天灵宝已是器物顶点
- **鸿蒙可用状态**：鸿蒙至宝会记录未见、见影、留印/参悟、认主、装备权柄、执掌/映照；低境界不可强占，道祖以上可按相性、因果和掌道尝试承接权柄
- **玄牝轮回玉例外**：主角伴生旧玉隐藏关联玄牝轮回玉，会在死亡后自发护住部分记忆和未竟因果，但主角与旁人并不知道真相，也不能低境界主动调用
