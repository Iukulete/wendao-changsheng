...
public:
    ...
    void InitEvents() {
        ...
        // 妖兽系列
        AddEvent({
            L"【危机】野狼妖袭击", L"暮色压低山林，一只额生灰纹的野狼妖沿着你的气味缀了半里，显然把你当成了今晚的血食。",
            {{L"拔剑迎战", {L"你借乱石卡住狼妖扑势，斩开妖气后炼化了一缕血煞\n修为+40", L"狼妖贴地突进，你避慢半拍，被利爪撕开肩背\n气血-40"}, 0},
             {L"借林势撤走", {L"你绕入密林断掉气味，没有把命赌在一场没必要的搏杀上", L"狼妖熟悉山径，追上来咬穿你的护身符\n气血-30"}, -5}}
        }, THEME_CULTIVATION);
        AddEvent({
        ...
        AddEvent({
            ...
            {{L"断其七寸", {L"你看准蛇妖换息的刹那出手，毒雾散尽后药气反哺经脉\n修为+45", L"毒牙擦破皮肉，寒意沿经脉上窜\n气血-45"}, 0}}
        }, THEME_CULTIVATION);
        AddEvent({
            L"【危机】巨蟒妖袭击", L"古树忽然开裂，藏在树腹里的巨蟒妖卷着腐叶和腥风探出半身，像一截活过来的山脉。",
            {{L"斩鳞破缠", {L"你贴着蟒身逆势而上，斩断妖鳞间的灵脉节点\n修为+60", L"巨蟒收紧身躯，几乎把你的护体灵气碾碎\n气血-55"}, 0}}
        }, THEME_CULTIVATION);
        AddEvent({
            L"【危机】狐妖袭击", L"月下旧亭灯火忽明忽暗，狐妖借熟人声音唤你回头，幻境里连风声都像是真的。",
            {{L"守心破幻", {L"你没有追逐幻象，只守住眉心一点清明，狐火碎成灵屑\n修为+55", L"你被幻境牵动心神，醒来时胸口已多了一道狐火灼痕\n气血-40"}, 0}}
        }, THEME_CULTIVATION);

        // 修士对决系列
        AddEvent({
            L"【对决】邪修", L"坊市外的破庙里，一名邪修盯上你的储物袋，还故意把杀意放得很轻，像在等你先露怯。",
            {{L"正面应战", {L"你没有被他的阴招带乱，反手震碎血符\n修为+70", L"邪修藏了一枚噬血钉，你一时不察被逼退数十步\n气血-60"}, 0},
             {L"暂避锋芒", {L"你借人群与夜色脱身，把他的气息记在心里", L"他追得太紧，逼你硬吃一记血符\n气血-40"}, -10}}
        }, THEME_CULTIVATION);
        AddEvent({
            L"【对决】散修", L"一名散修因灵草归属与你起了冲突。对方并非恶人，只是在道途窄处被逼得不肯退让。",
            {{L"点到为止", {L"你赢得干净，没有毁他根基，也从交手里磨出一分火候\n修为+50", L"对方临阵变招，你护住要害却仍被震伤\n气血-45"}, 0}}
        }, THEME_CULTIVATION);
        AddEvent({
            L"【对决】魔修", L"夜半行功时，识海忽然传来陌生笑声。魔修残魂循着你的灵台缝隙闯入，想借你的肉身重回世间。",
            {{L"焚识反杀", {L"你以神识为炉反困残魂，炼去杂念后道心反而更稳\n修为+150", L"残魂撞入灵台深处，险些夺走你的呼吸与记忆\n气血-70"}, 10}}
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【奇遇】负伤修士",
            L"雨后的山道满是血腥味，一位负伤修士靠在石碑下，怀里紧抱半枚碎玉，开口先问你敢不敢沾这段因果。",
            {
                {L"救助他", {
                    L"你替他稳住心脉。他没有多说谢，只把记着残篇的古修玉简压进你掌心\n修为+50",
                    L"他缓过一口气后忽然反咬，碎玉里弹出一道暗针\n气血-30",
                    L"他其实是魔修诱饵，临别前在你识海里留下一点阴冷心魔\n修为-30"
                }, 10},
                {L"无视离开", {
                    L"你没有贸然伸手，雨声很快把身后的呼救盖住",
                    L"他临死前把怨气钉在你的背影上，像一根拔不掉的冷刺\n寿命-5年"
                }, -5},
                {L"补刀夺宝", {
                    L"你出手很快，夺下他的储物袋，也把这笔债记进了自己心里\n灵石+20",
                    L"他临死反扑，碎玉炸出的灵光几乎贯穿你的护身法\n气血-30"
                }, -20}
            }
        }, THEME_GENERAL);
        ...
        AddEvent({
            L"【奇遇】神秘洞府",
            L"藤蔓后露出一线石门，门缝里有灵气一呼一吸，像某位古修离去前故意留下的试题。",
            {
                {L"小心探索", {
                    L"你逐寸探过阵纹，只取走灵石、月华草与一瓶翠灵丹，没有惊醒主阵\n灵石+15，丹药+3",
                    L"一处暗纹被尘土遮住，禁制回震入臂\n气血-20"
                }, 0},
                {L"强行破阵", {
                    L"你强行破开阵眼，夺得青冥阵盘与一批封存资源\n灵石+30，修为+80",
                    L"阵眼反噬如潮，石门内的灵压把你震出洞外\n气血-50"
                }, 5},
                {L"记下位置离开", {
                    L"你把石门方位记在心里，先等修为和情报都更稳时再来",
                    L"你再回来时，石门已被撬开，只剩一地冷灰"
                }, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【危机】妖兽袭击",
            L"山谷忽然安静，一只炼气期妖兽从断木后压低身形，盯着你的丹田灵光不放。",
            {
                {L"正面战斗", {
                    L"你稳住下盘与它硬拼，击败妖兽后剖出一枚温热妖丹\n修为+40，灵石+10",
                    L"妖兽力道比你预估更重，一爪拍碎护体灵气\n气血-40"
                }, 0},
                {L"尝试逃跑", {
                    L"你借乱石和溪声遮掩气息，终于甩开追踪",
                    L"你刚转身便被它追上，后背被妖气撕开一道口子\n气血-35"
                }, -5},
                {L"施展法术偷袭", {
                    L"你等它跃起的瞬间出手，一道法术贯穿妖核\n修为+50",
                    L"偷袭未成反激怒妖兽，它狂暴冲撞，逼得你连退数丈\n气血-50"
                }, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【机遇】宗门招收",
            L"山门外临时搭起问心台，外门长老按名册验骨、验心、验家世，许多少年排到天色发白。",
            {
                {L"参加考核", {
                    L"你在问心台上答得不卑不亢，通过考核后获赠灵石袋与宗门玉简\n灵石+20，修为+30",
                    L"你没能通过考核，但也看清了山门筛人的规矩"
                }, 5},
                {L"拒绝，散修自由", {
                    L"你没有把名册交出去，仍以散修身份继续行走",
                    L"山门资源与你擦肩而过，远处钟声像是在提醒你错过了什么"
                }, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【机遇】天材地宝",
            L"崖壁阴面生着一株千年灵芝，芝盖下灵露未干，守在旁边的妖兽却已经闻到有人靠近。",
            {
                {L"智取", {
                    L"你用碎石和气味引开妖兽，顺手采得月华草与灵芝\n修为+100",
                    L"妖兽察觉调虎离山，回身追得你几乎跌下崖壁\n气血-30"
                }, 5},
                {L"强取", {
                    L"你正面破开妖兽守势，连灵芝与妖丹一并拿下\n修为+120",
                    L"你没能压住妖兽凶性，只能带伤撤离\n气血-40"
                }, 0},
                {L"放弃", {
                    L"你没有被灵香迷住心神，绕开这处风险太重的崖壁",
                    L"等你再回头时，灵芝已经被别的修士连根取走"
                }, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【大机遇】前辈传承",
            L"洞府深处有一具坐化枯骨，指尖仍按着半卷功法。石壁上只留一句话：后来者，先问自己配不配拿。",
            {
                {L"接受传承", {
                    L"你在枯骨前行礼后接下传承，镇魂铜镜微亮，功法残章自行入识海\n修为+200",
                    L"传承路数与你根基相冲，强行容纳时心火逆涌\n气血-60"
                }, 10},
                {L"只取宝物", {
                    L"你没有碰功法，只取走养灵葫芦和封存资源\n灵石+50，丹药+10",
                    L"你刚碰到葫芦，枯骨袖中残阵便被惊醒\n气血-30"
                }, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【危机】魔修伏击",
            L"乱葬岭外阴风忽起，一名魔修早在路口埋下噬魂符，目标不是你的储物袋，而是你的肉身。",
            {
                {L"拼死一战", {L"你以伤换命斩碎噬魂符，反杀魔修后炼去一缕阴煞\n修为+150", L"魔修残魂撞入识海，你险些被夺走身体\n气血-50"}, 10},
                {L"舍财保命", {L"你丢出灵石扰乱阵脚，趁魔修贪念一动逃出符阵\n灵石-30", L"魔修嫌灵石太少，仍以阴符追上你\n气血-40"}, -5}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【见闻】渡劫修士",
            L"远山上雷云压成黑海，一位高阶修士正在渡劫。每一道雷都像在天地间写下一笔不能作假的道理。",
            {
                {L"远观雷痕", {L"你隔着安全距离记下雷痕流转，胸中瓶颈松动一线\n修为+120", L"劫雷余波越过山脊，仍把你震得气血翻涌\n气血-40"}, 5},
                {L"立即远离", {L"你没有拿低境界去赌天威，保住了这条路继续走下去", L"你离开得太早，错过一场难得的天地讲法"}, 0}
            }
        }, THEME_CULTIVATION);

        AddEvent({
            L"【大机遇】仙缘降临",
            L"云层忽然裂开一道金光，像有高处意志短暂垂目。它不是白送的福气，更像一次被标价的机会。",
            {
                {L"接住金光", {L"金光压入丹田，小境界壁垒当场松开\n直接提升一个小境界，寿命+50年", L"你福缘不足，金光只在掌心停了一瞬便散去"}, 20},
                {L"只取一缕", {L"你没有全盘承接，只留一缕金光温养经脉\n修为+100", L"金光被你拒得太硬，天威回震胸口\n气血-50"}, 0}
            }
        }, THEME_CULTIVATION);
        ...
        AddEvent({
            L"【奇遇】仙药园",
            L"雾气尽头是一片无人看守的仙药园，药畦整齐得不像荒废，反像主人刚刚离开片刻。",
            {
                {L"尽量采摘", {L"你采下月华草与多种仙药，迅速炼成一批可用丹丸\n丹药+15", L"药畦下的守护阵被惊醒，藤光抽中你的手臂\n气血-30"}, 0},
                {L"只取一株", {L"你只摘走一株月华草，临走前还把土痕复平\n丹药+5", L"守护阵仍察觉药气缺口，轻轻反噬了一下\n气血-15"}, 5}
            }
        }, THEME_CULTIVATION);

        AddEvent({
            L"【奇遇】神秘商人",
            L"夜市尽头坐着一位神秘商人，摊上没有标价，只有丹瓶、残卷和几件灵物在灯下静静发光。",
            {
                {L"购买丹药", {L"你买下一瓶翠灵丹与筑基丹，瓶底封印是真的\n丹药+5，灵石-15", L"丹香浮而不沉，是掺过水的假货\n灵石-15"}, 0},
                {L"购买功法", {L"你连同古修玉简一并买下，残卷虽旧，却正好补上行功缺口\n修为+80，灵石-25", L"功法残缺处太多，商人却早已收摊不见\n灵石-25"}, 0},
                {L"购买法宝", {L"你买下潮心灵珠与瞬影符，灵物入手时仍有余温\n修为+40，灵石-25", L"商人以障眼法掉包，留下的只是残次品\n灵石-25"}, 0},
                {L"不买", {L"你没有被灯下灵光牵着走，灵石还在自己手里", L"等你回头时，夜市尽头已经空无一人"}, 0}
            }
        }, THEME_GENERAL);
...
wstring g_hongmengOmenInfluence = L"本世鸿蒙天象尚浅，凡俗只见异象，少数古修把它当作某种创世权柄的余光。";
...
#define IDT_AGENT_BRIDGE 2003

HWND g_nameInput;
HWND g_btnStart;
int g_traceAutoplaySteps = 0;
int g_agentStateSequence = 0;
wstring g_agentLastCommand;
...
wstring GetAgentStatePath() {
    static bool initialized = false;
    static wstring path;
    if (!initialized) {
        DWORD size = GetEnvironmentVariableW(L"WENDAO_AGENT_STATE", nullptr, 0);
        if (size > 1) {
            vector<wchar_t> buffer(size);
            DWORD copied = GetEnvironmentVariableW(L"WENDAO_AGENT_STATE", buffer.data(), size);
            if (copied > 0 && copied < size) {
                path.assign(buffer.data(), copied);
            }
        }
...
wstring GetAgentCommandPath() {
    static bool initialized = false;
    static wstring path;
    if (!initialized) {
        DWORD size = GetEnvironmentVariableW(L"WENDAO_AGENT_COMMAND", nullptr, 0);
        if (size > 1) {
            vector<wchar_t> buffer(size);
            DWORD copied = GetEnvironmentVariableW(L"WENDAO_AGENT_COMMAND", buffer.data(), size);
            if (copied > 0 && copied < size) {
                path.assign(buffer.data(), copied);
            }
        }
...
bool IsAgentBridgeEnabled() {
    ...
    if (!initialized) {
        enabled = !GetAgentStatePath().empty() && !GetAgentCommandPath().empty();
        initialized = true;
    }
    return enabled;
}
...
bool ShouldHideTraceWindow() {
    ...
    if (!initialized) {
        hidden = (!GetTraceLogPath().empty() &&
            ...
            (IsAgentBridgeEnabled() && IsTruthyEnvValue(GetEnvironmentText(L"WENDAO_AGENT_HIDE")));
        initialized = true;
    }
    return hidden;
}
...
void InitializeStoryStateForLife() {
    ...
    for (const auto& thread : g_socialThreads) {
        ...
        AddUniqueLimited(g_storyState.npcMoods,
            thread.name + L"：" + thread.attitude + L"，关系" + GetRelationLabel(thread.relation), 8);
    }
}
...
StoryStatePatch BuildStoryPatchFromNarrative(const Event& event, const Choice& choice,
    ...
    patch.nextHook = g_lifeStoryHooks.empty()
        ? event.title + L"尚未完全结束，余波仍在人情与旧债里发热。"
    ...
    if (containsAnyLocal({L"本世主线", L"主线", L"线索", L"旧债", L"未竟", L"旧世残响"})) {
        patch.openThreadsToAdd.push_back(L"本世线索余波：这件事尚未完结，人情与旧债里已经生出枝节。");
    }
    ...
    if (containsAnyLocal({L"失传古法", L"旧法", L"功法", L"藏经", L"道网档案"})) {
        patch.openThreadsToAdd.push_back(L"失传古法余波：懂行者已注意到旧法骨架，认可、审查与争夺都压在暗处。");
    }
    ...
    for (const auto& thread : g_socialThreads) {
        ...
        patch.npcMoodNotes.push_back(thread.name + L"听过这阵风声，仍显得" +
            (positive ? L"靠近或押注" : (negative ? L"戒备或设局" : L"观望")) + L"。");
        if (++changed >= 2) break;
    }

    if (isAIEvent) {
        patch.openThreadsToAdd.push_back(L"天机生痕：" + event.title +
            L"已经进入本世持续因果，不再像无根偶遇。");
    }
    return patch;
}
...
wstring BuildStoryStateContext() {
    ...
    if (!g_storyState.synopsis.empty()) {
        wstring visibleSynopsis = SanitizePlayerFacingText(g_storyState.synopsis);
        if (!visibleSynopsis.empty()) ss << L"- 近期因果摘要: " << visibleSynopsis << L"\n";
    }
    if (!g_storyState.nextHook.empty()) {
        wstring visibleNextHook = SanitizePlayerFacingText(g_storyState.nextHook);
        if (!visibleNextHook.empty()) ss << L"- 可延续因果: " << visibleNextHook << L"\n";
    }
    if (!g_storyState.openThreads.empty()) {
        ...
        for (const auto& thread : g_storyState.openThreads) {
            if (count++ >= 6) break;
            wstring visibleThread = SanitizePlayerFacingText(thread);
            if (visibleThread.empty()) continue;
            ss << L"  * " << visibleThread << L"\n";
        }
    }
    ...
    if (!g_storyState.npcMoods.empty()) {
        ...
        for (const auto& mood : g_storyState.npcMoods) {
            if (count++ >= 5) break;
            wstring visibleMood = SanitizePlayerFacingText(mood);
            if (visibleMood.empty()) continue;
            ss << L"  * " << visibleMood << L"\n";
        }
    }
    if (!g_factionTie.name.empty()) {
...
wstring BuildFactionTieDigest() {
    ...
    auto highRealmStance = [](int favor) {
        if (favor >= 45) return L"敬畏倚重";
        if (favor >= 18) return L"愿结仙缘";
        if (favor <= -45) return L"畏惧避让";
        if (favor <= -18) return L"旧怨未平";
        return L"观望旧因";
    };
    wstring kind = g_factionTie.kind;
    wstring role = g_factionTie.role;
    wstring stance = g_factionTie.stance;
    wstring obligation = g_factionTie.obligation;
    wstring hook = g_factionTie.hook;
    ...
    if (g_player.realm >= HALF_IMMORTAL && earlySectLabel) {
        ...
        if (TextContainsAny(obligation, {L"身世", L"旧物"})) {
            obligation = L"身世与伴生旧玉的线索仍有未说尽之处。";
        ...
        stance = highRealmStance(g_factionTie.favor);
        hook = hook.empty()
            ? L"昔日势力已跟不上你的境界，但旧契、人情和资源账仍可能在仙路上回响。"
            : hook;
    }

    wstringstream ss;
    ss << g_factionTie.name << L"（" << kind << L"）"
       << L" · " << role
       << L" · " << stance
       << L" · " << favorLabel(g_factionTie.favor);
    if (g_factionTie.binding) ss << L" · 已有契约";
    if (!obligation.empty()) ss << L" · " << obligation;
    if (!hook.empty()) ss << L" · " << hook;
    return ss.str();
}
...
wstring GetVisibleReincarnationEcho() {
    if (!HasActualPastLifeEcho() && g_reincarnationEcho.find(L"前世") != wstring::npos) {
...
wstring SanitizePlayerFacingText(wstring text) {
    ...
    replaceAll(L"下一步该按 [3] 引气入体", L"此时可按 [3] 引气入体");
    replaceAll(L"「这一步能站住，但别急着等人夸。下一步还要更稳。」",
        L"「这一步能站住，但别急着等人夸。把眼前的路走稳。」");
    ...
    auto removePlanningSentence = [&](const vector<wstring>& keys) {
        ...
        while (removed) {
            ...
            for (const auto& key : keys) {
                ...
                if (pos != wstring::npos && (hit == wstring::npos || pos < hit)) {
                    hit = pos;
                }
            }
            if (hit == wstring::npos) break;

            size_t start = text.find_last_of(startMarks, hit);
            if (start == wstring::npos) {
                start = 0;
            } else if (text[start] == L'|') {
                // Keep the previous sentence, remove the separator and the planning aside.
            } else {
                start += 1;
            }
            ...
            size_t end = text.find_first_of(endMarks, hit);
            if (end == wstring::npos) {
                end = text.size();
            } else {
                end += 1;
...
wstring GetEraSummaryText() {
    ...
    ss << (HasActualPastLifeEcho() ? L"轮回余烬: " : L"旧玉梦兆: ")
...
wstring BuildCompanionJadeDreamOmen() {
    ...
    if (g_generation <= 1) {
        ...
        pressure = L"它像一枚隔着天幕的路标，只提醒你今生取舍会留下回声。";
    } else {
...
wstring BuildHongmengOmenText() {
    wstringstream ss;
    ss << L"【本世鸿蒙天象】\n";
    ss << L"传闻名号: " << g_hongmengOmenTreasureName << L"\n";
    ss << L"所映道意: " << g_hongmengOmenDao << L"\n";
    ss << L"显化: " << g_hongmengOmenManifestation << L"\n";
    ss << L"当世影响: " << g_hongmengOmenInfluence << L"\n";
    if (GetHongmengAccessTier() >= 2) {
        ss << L"边界: " << BuildHongmengUsabilityText() << L"\n";
    } else if (GetHongmengAccessTier() == 1) {
        ss << L"边界: 你只能借势、留印和参悟；若强求占有，异象反而会成为反噬。\n";
    } else {
        ss << L"边界: 你目前只能把它当作异象与线索，真正来历仍隔着天幕。\n";
    }
    return ss.str();
}
...
wstring BuildHongmengTreasuresText() {
    ...
    if (GetHongmengAccessTier() == 0 && CountHongmengInsightKinds() < 2) {
        ss << L"世间确有极古老的创世权柄传闻，但绝大多数修士连完整名号都不知晓。\n";
        ss << L"你目前能确认的，只有本世天象与自己留下的少量印记。\n\n";
        ss << BuildHongmengProgressContext() << L"\n";
        ss << L"本世天象: " << BuildHongmengOmenBrief() << L"\n";
        ss << L"其余名号仍在传闻之外。境界、因果与参悟越深，图录才会逐步清晰。\n";
        return ss.str();
    }
    ...
    if (g_player.realm >= DAO_ANCESTOR || relic.daoDepth >= 120 || relic.resonance >= 180) {
        ...
        if (canMaster) {
            ...
            evt.choices = {
                ...
                {L"只借余光", {
                    wstring(L"你借") + treasureDao + L"余光照见眼前缺口。" + treasure.insight + L"\n修为+120，掌道+12，灵宝共鸣+8",
                    L"余光过盛，神魂短暂失衡。\n气血-25"
                }, 8},
                {L"谨慎参悟", {
...
bool HasActualPastLifeEcho() {
    return g_generation > 1 || !g_legacySystem.GetPastLives().empty();
}
...
void RefreshSocialAgentState(SocialThread& thread) {
    ...
    if (antagonistTie) {
        ...
        thread.nextMove = L"继续收敛气机，观察你是否看得出破绽";
    } else {
        thread.nextMove = thread.relation >= 18
            ? L"试着拉近关系"
...
wstring BuildSocialNpcUtterance(const SocialThread& thread) {
    ...
    bool latePath = g_player.realm >= NASCENT_SOUL;
    auto has = [&](const wstring& needle) {
        return thread.role.find(needle) != wstring::npos ||
               thread.attitude.find(needle) != wstring::npos ||
               thread.hook.find(needle) != wstring::npos;
    ...
    if (has(L"身世")) {
        return HasPriorLifeEcho()
            ...
            : (thread.role == L"势力牵连"
                ? (latePath
                    ? L"「你已走到能听答案的时候，可答案背后的人，也终于有资格看见你了。」"
    ...
    if (has(L"父亲")) {
        ...
        if (latePath) return L"「你走到今日，已不是给谁证明；越近天门，越要记得自己为何入道。」";
        return L"「入道不是给别人看的，别急着把自己押进大局。」";
    }
    if (has(L"母亲")) {
        if (gifted) return L"「他们夸你，是想提前押注；我护你，是怕你太早被看穿。」";
        if (weak) return latePath
            ? L"「走到这一步仍会疼，就别装作没人替你心疼。」"
            : L"「测灵碑冷，娘不冷，你慢慢走也有人给你留灯。」";
    ...
    if (has(L"资源把关者")) {
        return latePath
            ? L"「越近天门，资源越不是赏赐；拿得出代价，再谈破境。」"
            : L"「灵井不是给热血少年的，拿得出筹码再谈破境。」";
    }
    if (has(L"功法见证者")) {
...
wstring BuildRelationAftershockText(const SocialThread& thread, int oldRelation, int delta,
    ...
    if (thread.role == L"欺压者" || thread.role == L"竞争者" || thread.role == L"资源把关者") {
        ...
        if (worsened) {
            return thread.name + L"抓住这次破绽当成新把柄，嫉妒与轻慢一起发酵，话里已经带出设局的冷意。";
        }
    }
    ...
    if (TextContainsAny(thread.name + thread.role, {L"清蘅真人", L"师尊", L"护道人"})) {
        ...
        if (worsened) {
            return thread.name + L"没有替你遮掩受挫，只把这处缺口压进更重的护道目光里。";
        }
    }
    if (TextContainsAny(thread.name + thread.role, {L"洛凝霜", L"桃华剑脉"})) {
        ...
        if (worsened) {
            return thread.name + L"收回几分笑意，像是已经看见你尚未补上的缺口。";
        }
    }
    if (TextContainsAny(thread.name + thread.role, {L"玄衡子", L"掌律真人", L"太上玄衡观"})) {
        if (improved) {
        ...
        if (worsened) {
            return thread.name + L"抓住这次破绽，掌律玉简上的寒意更重了。";
        }
    }
    ...
    if (weak && worsened) {
        return thread.name + L"借这次失手确认你根基不稳，轻慢之声已经在同辈间散开。";
    }
    if (improved) {
...
wstring BuildActionEmotionFeedback(const wstring& action, bool positive) {
    ...
    if (ancestryLead) {
        ...
        if (positive) {
            ...
            ss << actor << L"把这次受挫记成可审之处，掌律玉简上的寒意更重。";
        }
        ...
        if (positive) {
            ...
            ss << actor << L"没有嘲笑，只把距离收回半步，像是已经看见你脚下尚未站稳。";
        }
        ...
        if (positive) {
            ...
            ss << actor << L"替你压住一点反噬，却先问清楚这份代价究竟由谁承担。";
        }
...
wstring BuildSocialTalentPressureText() {
    ...
    if (g_player.realm >= NASCENT_SOUL) {
        if (g_player.IsExceptionalRoot()) {
            return L"你这些年锋芒已成气候，赞许、押注和嫉妒都不再停在灵根上，而是落到你能否撑住大道压力。";
        }
        if (g_player.IsWeakRoot()) {
            return L"早年根骨短处仍有人记得，但你能走到此境，本身已经让轻慢者不得不重新估量。";
        }
        if (g_player.hasBalancedRoots) {
            return L"五行根基的后劲开始显出分量，有人把你当成可押的大道种子，也有人等着看你破绽。";
        }
        return L"你走到如今，资质评价已不是唯一筹码；人情、战绩、道心和旧债都在重新给你定价。";
    }
    if (g_player.IsExceptionalRoot()) {
...
void GenerateSocialThreads() {
    ...
    int treasureEcho = g_legacySystem.GetLegacyBonus(LEGACY_TREASURE);
    int reputationEcho = g_legacySystem.GetLegacyBonus(LEGACY_REPUTATION);
    bool priorLife = HasActualPastLifeEcho();
    auto& inherited = g_legacySystem.GetInheritedLegacies();
...
void GenerateLifeStoryHooks() {
    ...
    if (HasActualPastLifeEcho() && !unfinishedKarmas.empty()) {
        g_lifeStoryHooks.push_back(L"前世未竟因果：" + unfinishedKarmas[0]);
    }

    if (HasActualPastLifeEcho() && !pastFragments.empty()) {
...
bool IsStageMismatchedAiEvent(const wstring& title, const wstring& description, const vector<wstring>& choices) {
    if (g_player.realm < GOLDEN_CORE) return false;

    wstring combined = title + L" " + description;
    for (const auto& choice : choices) {
        combined += L" " + choice;
    }

    vector<wstring> earlyOnly = {
        L"测灵", L"测灵碑", L"测灵台", L"入门试炼", L"入门信物",
        L"内门名额", L"稳进内门", L"必入内门", L"外门少年", L"杂役牌",
        L"外门候选", L"杂役试炼", L"没稳进内门"
    };
    if (TextContainsAny(combined, earlyOnly)) return true;

    if (g_player.realm >= NASCENT_SOUL &&
        TextContainsAny(combined, {L"少年道途", L"热血少年", L"同龄人", L"初入山门"})) {
        return true;
    }
...
void EnterAiEventFromContext(PlayerContext ctx) {
    ...
    bool loadedFromModel = g_aiGen.TryLoadExternalEvent(aiTitle, aiDesc, aiChoices);
    if (loadedFromModel && IsStageMismatchedAiEvent(aiTitle, aiDesc, aiChoices)) {
        loadedFromModel = false;
        g_lastAiBackend = L"模板校准";
        g_lastAiStatus = L"动态事件阶段错位，已由规则模板接管。";
        AppendTraceLog(L"AI_STAGE_FILTER",
            L"discarded=" + aiTitle + L"\n" + aiDesc);
    }
    if (loadedFromModel) {
...
PlayerContext BuildPlayerContext() {
    ...
    if (HasFactionTie()) {
        ctx.familyState += L"；本世势力:" + BuildFactionTieDigest();
    }
    ctx.socialState = GetSocialDigest();
    if (!g_socialThreads.empty()) {
        ctx.socialState += L"\n人物表面状态:\n" + BuildSocialThreadDigest(5);
    }
    for (const auto& thread : g_socialThreads) {
...
wstring BuildPlayerVisibleOutcomeText(wstring text) {
    ...
    wstring relicLabel = L"灵宝共鸣+";
    if (g_generation <= 1 || g_player.realm < GOLDEN_CORE) {
        relicLabel = L"器鸣+";
    } else if (g_player.realm < TRUE_IMMORTAL) {
        relicLabel = L"灵宝感应+";
    }
...
void ApplyStoryThreadEffects(const Event& event, const Choice& choice, const wstring& outcome, bool isAIEvent) {
    ...
    if (const HongmengTreasure* treasure = FindHongmengTreasureInText(text)) {
        add((successLike ? L"鸿蒙余光：" : L"鸿蒙余震：") +
            wstring(treasure->name) + L"投影仍在识海边缘回响，" +
            treasure->dao + L"的痕迹变得更清晰。");
    }

    if (TextContainsAny(text, {L"伴生玉佩", L"黑白旧玉", L"玉佩", L"梦中玉意", L"阴阳玉痕"})) {
        add(wstring(successLike ? L"旧玉微温：" : L"旧玉受扰：") +
            (HasActualPastLifeEcho()
                ? L"那枚黑白旧玉仍未显露真名，却继续把前世记忆、今生选择和轮回回响牵在一起。"
                : L"那枚黑白旧玉仍未显露真名，只把今生选择、生死梦兆和轮回微光牵在一起。"));
    }

    if (TextContainsAny(text, {L"前世未竟", L"未竟因果", L"旧因", L"旧债", L"前世", L"旧名"})) {
        if (HasActualPastLifeEcho()) {
            add(wstring(successLike ? L"旧因回响：" : L"旧债压身：") +
    ...
    if (TextContainsAny(text, {L"清蘅真人", L"师尊", L"护道人"})) {
        add(wstring(successLike ? L"师尊余波：" : L"师尊压目：") +
            L"清蘅真人记住了你的表现，护道、责罚与传法的分量都被这一事压重。");
    }

    if (TextContainsAny(text, {L"玄衡子", L"掌律真人", L"太上玄衡观"})) {
        add(wstring(successLike ? L"掌律受挫：" : L"掌律压身：") +
            L"玄衡子的门规审查没有散去，掌律玉简上的寒意仍压在此事之后。");
    }

    if (TextContainsAny(text, {L"洛凝霜", L"桃华剑脉", L"桃林试剑"})) {
        add(wstring(successLike ? L"桃林余温：" : L"桃林冷意：") +
            L"洛凝霜没有无条件偏向你，她记下的是此刻的胆色、心性与剑意。");
    }

    if (TextContainsAny(text, {L"江照雪", L"江氏", L"战帖", L"约战"})) {
        add(wstring(successLike ? L"照雪战意：" : L"照雪带刺：") +
            L"这份争胜心没有散去，战帖、同阵与江氏目光都因此多了一层分量。");
    }

    if (TextContainsAny(text, {L"祁无咎", L"无咎", L"空帖", L"外显修为", L"藏拙"})) {
        add(wstring(successLike ? L"无咎留帖：" : L"无咎转隐：") +
            L"祁无咎仍只露一部分底细，人情、藏拙和空帖都没有说尽。");
    }

    if (TextContainsAny(text, {L"沈听澜", L"听澜", L"阵钥", L"灵机列车", L"道网密讯"})) {
        add(wstring(successLike ? L"听澜阵讯：" : L"听澜留半：") +
            L"沈听澜留下阵纹、道网和半真半假的情报，合作仍不等于无条件信任。");
    }

    if (TextContainsAny(text, {L"陆青鸢", L"青鸢", L"医道仙官"})) {
        add(wstring(successLike ? L"青鸢问价：" : L"青鸢停针：") +
            L"陆青鸢记下你如何对待伤者、灵脉与代价；医道善意也有必须偿还的因果。");
    }

    if (TextContainsAny(text, {L"阿岑", L"枯井兄妹", L"枯井镇", L"干粮"})) {
        add(wstring(successLike ? L"枯井成善：" : L"枯井成债：") +
            L"枯井镇小人物把这次选择记进心里，善名、暗路或沉默旧债都从此有了源头。");
    }

    if (HasFactionTie() && TextContainsAny(text, {
        g_factionTie.name, L"本世势力", L"势力", L"宗门", L"仙朝", L"工坊", L"道网", L"残宗", L"名册"
    })) {
        add((successLike ? L"势力松动：" : L"势力收紧：") +
            g_factionTie.name + L"重新衡量你；审查、资源与旧债的分量随之变化。");
    }
    ...
    for (const auto& thread : g_socialThreads) {
        ...
        add((successLike ? L"人情生温：" : L"人情生隙：") +
            thread.name + L"（" + thread.role + L"）记住了你的表现，眼下态度是" +
            GetRelationLabel(thread.relation) + L"。");
        break;
    }

    if (TextContainsAny(text, {L"旧世残响", L"上一纪元", L"旧世", L"遗址", L"断代", L"废墟", L"残响"})) {
        add(wstring(successLike ? L"旧世回响：" : L"旧世反噬：") +
            L"上一纪元留下的物证仍在影响今生，遗址、制度与旧器之间多了一道可追的暗纹。");
    }

    if (TextContainsAny(text, {L"本世器物", L"当世兵刃", L"当世法宝", L"器痕", L"器纹", L"法宝", L"兵刃"})) {
        add(wstring(successLike ? L"器物留痕：" : L"器物裂痕：") +
            L"今生器物本体终会失散，但这次取舍可能留下器痕，供通天灵宝残印在轮回中辨认。");
    }

    if (TextContainsAny(text, {L"大道", L"掌道", L"道祖", L"天道", L"道音"}) ||
        ExtractValue(outcome, L"掌道+") > 0) {
        add(wstring(successLike ? L"大道明痕：" : L"大道受压：") +
            L"这次抉择让你的道心更清楚自身缺口，同一条大道也因此留下回声。");
    }

    if (isAIEvent && added == 0) {
        add(wstring(setbackLike ? L"天机余波：" : L"天机生痕：") +
            L"「" + event.title + L"」没有当场结束，相关人和事已经在今生留下余温。");
    }
}
...
wstring BuildImmediateGoalDigest() {
    ...
    if (g_player.realm == MAHAYANA && g_player.level >= 9 &&
        g_player.exp >= g_player.GetExpNeeded() && !g_player.hasBalancedRoots) {
        return L"当前要事: 修为已足，但五行未均；先历练寻找五行秘境、五行老祖或洗髓机缘，补齐短板再冲仙门。";
    }
    if (g_player.realm != MORTAL && g_player.level >= 9) {
...
wstring BuildNearFutureDigest() {
    ...
    if (!g_lifeStoryHooks.empty()) {
        ...
        wstring hook = g_lifeStoryHooks[index];
        if (g_player.realm >= HALF_IMMORTAL &&
            TextContainsAny(hook, {L"入门", L"内门", L"外门", L"杂役", L"山门试探"})) {
            hook = HasFactionTie()
                ? L"旧宗因果：" + BuildFactionTieDigest()
                : L"早年山门试炼已化成旧宗因果，后续看的是师承、人情与飞升后的站位。";
        }
        addHint(L"本世暗线：" + hook);
    }
    if (HasFactionTie()) {
    ...
    if (HasActualPastLifeEcho()) {
        ...
        if (unfinished.empty() && !fragments.empty()) {
    ...
    if (GetHongmengAccessTier() > 0 || CountHongmengInsightKinds() > 0) {
        ...
        } else if (g_player.realm >= TRUE_IMMORTAL || CountHongmengInsightKinds() >= 3) {
            addHint(L"古老天象：" + BuildHongmengOmenBrief());
        }
    }
...
wstring BuildMainWorldDigest() {
    ...
    ss << L"\n" << (HasActualPastLifeEcho() ? L"轮回余烬: " : L"旧玉梦兆: ")
...
wstring JsonEscape(const wstring& text) {
    wstringstream ss;
    for (wchar_t ch : text) {
        switch (ch) {
            case L'\\': ss << L"\\\\"; break;
...
wstring AgentGameStateName() {
    switch (g_gameState) {
        case STATE_MENU: return L"MENU";
        case STATE_GAME: return L"GAME";
        case STATE_EVENT: return L"EVENT";
        case STATE_GAMEOVER: return L"GAMEOVER";
        case STATE_INFO: return L"INFO";
        case STATE_AI_WAIT: return L"AI_WAIT";
        default: return L"UNKNOWN";
    }
}

void WriteJsonField(wstringstream& ss, const wstring& name, const wstring& value, bool comma = true) {
    ss << L"\"" << name << L"\":\"" << JsonEscape(value) << L"\"";
    if (comma) ss << L",";
    ss << L"\n";
}

void WriteAgentState() {
    wstring path = GetAgentStatePath();
    if (path.empty()) return;

    wstringstream ss;
    ss << L"{\n";
    ss << L"\"sequence\":" << ++g_agentStateSequence << L",\n";
    WriteJsonField(ss, L"state", AgentGameStateName());
    ss << L"\"generation\":" << g_generation << L",\n";
    ss << L"\"canBreakthrough\":" << (g_player.CanBreakthrough() ? L"true" : L"false") << L",\n";
    ss << L"\"heavenlyDaoReady\":" << (CanAttainHeavenlyDao() ? L"true" : L"false") << L",\n";

    ss << L"\"player\":{\n";
    WriteJsonField(ss, L"name", g_player.name);
    WriteJsonField(ss, L"era", g_worldEraName);
    WriteJsonField(ss, L"realm", GetRealmName(g_player.realm));
    ss << L"\"realmIndex\":" << (int)g_player.realm << L",\n";
    ss << L"\"level\":" << g_player.level << L",\n";
    ss << L"\"exp\":" << g_player.exp << L",\n";
    ss << L"\"needExp\":" << g_player.GetExpNeeded() << L",\n";
    ss << L"\"hp\":" << g_player.hp << L",\n";
    ss << L"\"maxHp\":" << g_player.maxHp << L",\n";
    ss << L"\"age\":" << g_player.age << L",\n";
    ss << L"\"lifespan\":" << g_player.lifespan << L",\n";
    ss << L"\"karma\":" << g_player.karma << L",\n";
    ss << L"\"spiritStones\":" << g_player.spiritStones << L",\n";
    ss << L"\"pills\":" << g_player.pills << L",\n";
    ...
    WriteJsonField(ss, L"nearFuture", BuildNearFutureDigest());
    WriteJsonField(ss, L"feedback", BuildGameFeedbackDigest());
    WriteJsonField(ss, L"recentMemory", BuildRecentMemoryDigest());
    WriteJsonField(ss, L"aiStatus", BuildAiStatusDigest());

    ss << L"\"event\":";
    if (g_gameState == STATE_EVENT && g_currentEvent) {
        ss << L"{\n";
        WriteJsonField(ss, L"source", g_currentEventSource);
        WriteJsonField(ss, L"title", g_currentEvent->title);
        WriteJsonField(ss, L"description", g_currentEvent->description);
        ss << L"\"choices\":[";
        for (size_t i = 0; i < g_currentEvent->choices.size(); ++i) {
            if (i > 0) ss << L",";
            ss << L"{\"index\":" << (i + 1) << L",\"text\":\""
               << JsonEscape(g_currentEvent->choices[i].description) << L"\"}";
        }
        ss << L"]\n}";
    } else {
        ss << L"null";
    ...
    if (g_gameState == STATE_MENU) {
        ...
        ss << L"\"KEY 1 修炼\",\"KEY 2 历练\",\"KEY 3 突破\",\"KEY 4 疗伤服药\","
           << L"\"KEY 5 灵石闭关\",\"KEY 6 铸炼器物\",\"KEY S 保存\",\"KEY L 读取\"";
    } else if (g_gameState == STATE_EVENT && g_currentEvent) {
        for (size_t i = 0; i < g_currentEvent->choices.size(); ++i) {
            if (i > 0) ss << L",";
            ss << L"\"KEY " << (i + 1) << L"\"";
        }
    } else if (g_gameState == STATE_GAMEOVER) {
        ss << L"\"KEY N 下一世\",\"KEY ESC 退出\"";
    } else if (g_gameState == STATE_INFO) {
        ss << L"\"KEY ESC 返回\"";
    } else if (g_gameState == STATE_AI_WAIT) {
        ss << L"\"WAIT\",\"KEY ESC 放弃本次推演\"";
    }
    ss << L"]\n";
    ss << L"}\n";

    wofstream file(path.c_str(), ios::trunc);
    UseUtf8Locale(file);
    if (file) {
        file << ss.str();
    }
...
WPARAM AgentKeyFromToken(wstring token) {
    transform(token.begin(), token.end(), token.begin(), towupper);
    if (token == L"ESC" || token == L"ESCAPE") return VK_ESCAPE;
    if (token == L"DOWN") return VK_DOWN;
    if (token == L"UP") return VK_UP;
    if (token == L"PGDN" || token == L"PAGEDOWN") return VK_NEXT;
    if (token == L"PGUP" || token == L"PAGEUP") return VK_PRIOR;
    if (token.size() == 1) return (WPARAM)token[0];
    return 0;
}

void ExecuteAgentCommand(HWND hWnd, const wstring& rawCommand) {
    wistringstream in(rawCommand);
    wstring sequence;
    wstring op;
    in >> sequence >> op;
    if (op.empty()) {
    ...
    transform(op.begin(), op.end(), op.begin(), towupper);

    if (op == L"START") {
        wstring daoName;
        getline(in, daoName);
        while (!daoName.empty() && iswspace(daoName.front())) daoName.erase(daoName.begin());
        if (daoName.empty()) daoName = L"玄微";
        if (g_gameState == STATE_MENU) {
            StartNewGameWithDaoName(hWnd, daoName, L"后台代理开局");
        }
    } else if (op == L"KEY" || op == L"ACTION" || op == L"CHOICE") {
        wstring keyToken;
        in >> keyToken;
        WPARAM key = AgentKeyFromToken(keyToken);
        if (key != 0) {
            PostMessageW(hWnd, WM_KEYDOWN, key, 0);
        }
    } else if (op == L"WAIT") {
        // no-op; useful for external drivers that want a fresh state tick.
    } else if (op == L"QUIT") {
        PostQuitMessage(0);
    }
}

void HandleAgentBridgeTick(HWND hWnd) {
    if (!IsAgentBridgeEnabled()) return;

    wstring commandPath = GetAgentCommandPath();
    if (!commandPath.empty()) {
        wifstream file(commandPath.c_str());
        UseUtf8Locale(file);
        if (file) {
            wstringstream buffer;
            buffer << file.rdbuf();
            wstring command = buffer.str();
            while (!command.empty() && (command.back() == L'\n' || command.back() == L'\r' || iswspace(command.back()))) {
                command.pop_back();
            }
            if (!command.empty() && command != g_agentLastCommand) {
                g_agentLastCommand = command;
                AppendTraceLog(L"AGENT_ACTION", command);
                ExecuteAgentCommand(hWnd, command);
            }
        }
    }
                    ...
                    if (!g_player.CanBreakthrough()) {
                            ...
                            L"尝试突破至 " + breakthroughTarget + L"。");
                        {
                            ...
                            if (success) {
                                ...
                                if (breakthroughTarget == L"炼气期") {
                                    failMsg += L"\n引气入体未成，肉身根基被震退一线，需要先稳回凡人九层。";
                                }
                                if (GetEraBreakthroughModifier() < 0) {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow) {
    ...
    if (IsAgentBridgeEnabled()) {
        SetTimer(g_hWnd, IDT_AGENT_BRIDGE, 180, nullptr);
        WriteAgentState();
    }
