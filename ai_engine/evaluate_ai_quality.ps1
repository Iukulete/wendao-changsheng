...
$cases = @(
    ...
    @{
        ...
        Prompt = New-Prompt `
            ...
            -Social "本世人脉: 顾临渊（父亲）· 克制认可 · 善意 · 想要确认你能活着走稳道途 · 忌惮你太早暴露前世异常 · 下一步私下护短并试探你是否稳得住: 他没有当众夸你，却私下把一枚入门信物交到你手里。NPC情绪代理口吻「你这份根骨可以骄傲，但不能被旁人一句夸就牵着走。」`n叶微澜（母亲）· 护持期待 · 亲近 · 想要护住你的少年心气 · 忌惮旁人提前押注: 她替你压下族中闲话，只提醒你别太早暴露前世般的眼神。`n江照雪（竞争者）· 嫉妒试探 · 恶感 · 想要证明你没有资格压过自己 · 忌惮你的资质和旧名抢走自己的位置 · 下一步借下一场试炼设局: 此人表面祝贺你灵根出众，背后却在打听你的家世短处。" `
    ...
    @{
        ...
        Prompt = New-Prompt `
            ...
            -Social "本世人脉: 祁无咎（接引修士）· 谨慎观察 · 观望 · 外显金丹 3层 · 外显修为未必可信 · 想要看清你是哪种可结交的人 · 忌惮自己藏拙被你看穿 · 下一步继续隐藏真实修为，看你是否识破: 此人愿意给你一次试炼机会，但还在判断你是否值得投入资源。NPC情绪代理口吻「先别急着站队，我还想看看你到底是哪种人。」" `
