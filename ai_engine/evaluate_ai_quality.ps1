...
$cases = @(
    ...
    @{
        ...
        Prompt = New-Prompt `
            ...
            -Social "本世人脉: 顾临渊（父亲）· 克制认可 · 善意: 他没有当众夸你，却私下把一枚入门信物交到你手里。NPC情绪代理口吻「你这份根骨可以骄傲，但不能被旁人一句夸就牵着走。」`n叶微澜（母亲）· 护持期待 · 亲近: 她替你压下族中闲话，只提醒你别太早暴露前世般的眼神。`n江照雪（竞争者）· 嫉妒试探 · 恶感: 此人表面祝贺你灵根出众，背后却在打听你的家世短处。" `
    ...
    @{
        ...
        Prompt = New-Prompt `
            ...
            -Social "本世人脉: 祁无咎（接引修士）· 谨慎观察 · 观望 · 外显金丹 3层 · 外显修为未必可信: 此人愿意给你一次试炼机会，但还在判断你是否值得投入资源。NPC情绪代理口吻「先别急着站队，我还想看看你到底是哪种人。」" `
