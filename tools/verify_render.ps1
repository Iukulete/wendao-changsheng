...
$expected = @(
    ...
    "audio_settings_narrow_top_800x720.png",
    "audio_settings_narrow_bottom_800x720.png",
    "main_1280x720.png",
    "main_1440x900.png",
    "main_1920x1080.png",
    "main_narrow_top_800x720.png",
    "main_narrow_bottom_800x720.png",
    "objective_1280x720.png",
    "objective_narrow_top_800x720.png",
    "objective_narrow_bottom_800x720.png",
    "cultivation_1280x720.png",
    "cultivation_narrow_top_800x720.png",
    "cultivation_narrow_bottom_800x720.png",
    "inventory_1280x720.png",
    "inventory_narrow_top_800x720.png",
    "inventory_narrow_bottom_800x720.png",
    "armory_1280x720.png",
    ...
    "event_result_1280x720.png",
    "event_result_narrow_800x720.png",
    "journal_1280x720.png",
    "journal_narrow_800x720.png",
    "reincarnation_1280x720.png",
    "reincarnation_narrow_800x720.png",
    "normal_combat_1280x720.png",
    "normal_combat_1440x900.png",
    "normal_combat_narrow_top_800x720.png",
    "normal_combat_narrow_bottom_800x720.png",
    "dungeon_route_1440x900.png",
    "dungeon_route_narrow_top_800x720.png",
    "dungeon_route_narrow_bottom_800x720.png",
    "dungeon_route_progress_1440x900.png",
    "dungeon_combat_1440x900.png",
    "dungeon_combat_narrow_top_800x720.png",
    "dungeon_combat_narrow_bottom_800x720.png",
